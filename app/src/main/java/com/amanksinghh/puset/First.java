...
import com.amanksinghh.puset.timetable.FirstSem;
...
public class First extends AppCompatActivity {
    ...
    TextView sub1, sub2, sub3, sub4, sub5, sub6,sub7, tt1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tt1 = findViewById(R.id.firstTT);
        mAuth = FirebaseAuth.getInstance();

        sub1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ref = FirebaseDatabase.getInstance().getReference("First");
                ref.addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        String Sub1 = dataSnapshot.child("Sub1").getValue().toString();
                        sub1.setText(Sub1);
                        /*sub1.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
        ...
        sub7.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ref.addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        String Sub7 = dataSnapshot.child("Sub7").getValue().toString();
                        sub7.setText(Sub7);
                       /* sub7.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                String url = sub7.getText().toString();
                                Intent i = new Intent(Intent.ACTION_VIEW);
                                i.setData(Uri.parse(url));
                                startActivity(i);
                            }
        ...
        tt1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(First.this , FirstSem.class));
            }
        });
